...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file Computer_timing_summary_routed.rpt -pb Computer_timing_summary_routed.pb -rpx Computer_timing_summary_routed.rpx"
...
set rc [catch {
  ...
  phys_opt_design -directive Explore
  write_checkpoint -force Computer_postroute_physopt.dcp
  create_report "impl_1_post_route_phys_opt_report_timing_summary_0" "report_timing_summary -max_paths 10 -warn_on_violation -file Computer_timing_summary_postroute_physopted.rpt -pb Computer_timing_summary_postroute_physopted.pb -rpx Computer_timing_summary_postroute_physopted.rpx"
  create_report "impl_1_post_route_phys_opt_report_bus_skew_0" "report_bus_skew -warn_on_violation -file Computer_bus_skew_postroute_physopted.rpt -pb Computer_bus_skew_postroute_physopted.pb -rpx Computer_bus_skew_postroute_physopted.rpx"
