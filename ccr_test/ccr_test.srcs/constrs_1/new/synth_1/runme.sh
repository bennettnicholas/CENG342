...
HD_PWD='E:/CENG342/ccr_test/ccr_test.srcs/constrs_1/new/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CCR_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CCR_test.tcl
