...
HD_PWD='C:/Users/7380314/Documents/GitHub/CENG342/lab04/lab_04/lab_04.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log N_bit_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source N_bit_adder.tcl -notrace
