...
HD_PWD='C:/Users/7380314/Documents/GitHub/CENG342/lab04/lab_04/lab_04.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log N_bit_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source N_bit_adder.tcl
