...
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports {ci}]
...
#set_property -dict {PACKAGE_PIN T8 IOSTANDARD LVCMOS18} [get_ports {selbit}]
...
## LEDs
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {o}]
