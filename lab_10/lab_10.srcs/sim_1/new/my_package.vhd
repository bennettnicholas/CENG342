...
package my_package is
 ...
 type control_t is(
    ...
    Memsel,  -- select memory to register file input : active high
    ...
    dle,     -- enable load of register file         : active low
    fle,     -- enable load of flags register        : active low
    ...
    marle,   -- enable MAR to latch address          : active low
    mctle,   -- enable memory control register latch : active low
