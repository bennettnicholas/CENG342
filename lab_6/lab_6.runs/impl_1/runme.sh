...
HD_PWD='E:/CENG342/lab_6/lab_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Generic_ALU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Generic_ALU.tcl -notrace
