...
HD_PWD='E:/CENG342/lab_6/lab_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Generic_ALU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Generic_ALU.tcl
